      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <div className="mt-8 flex gap-3">
            <a href="#get-started" className={cn(buttonVariants({ size: "lg" }), "rounded-lg text-xs uppercase tracking-wider font-medium px-8")}>
              Try free for 7 days
            </a>
      ...
      <div className="bg-primary/[0.03] px-6 pt-36 pb-20">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5">
            ...
            <a href="#get-started" className={cn(buttonVariants({ size: "lg" }), "mt-8 rounded-lg text-xs uppercase tracking-wider font-medium px-8")}>
              Start for free
            </a>
          </div>
    ...
    <section className="w-full px-6 pt-36 pb-20 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        <div className="max-w-lg mb-12">
          ...
          <div className="mt-8 flex gap-3">
            <a href="#get-started" className={cn(buttonVariants({ size: "lg" }), "rounded-lg text-xs uppercase tracking-wider font-medium px-8 gap-2")}>
              Get Started
