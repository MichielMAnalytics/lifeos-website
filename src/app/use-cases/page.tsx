...
const useCases = [
  {
    ...
    description:
      "Send a voice message on Telegram and your AI LifeCoach adds it to your dashboard. Tasks, ideas, journal entries -- captured instantly without opening an app. Whether you are walking, driving, or just away from your desk, your voice becomes structured data in seconds. No transcription errors, no lost context.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Stop copy-pasting context between productivity apps. Tasks, goals, journals, plans -- all in one place, all connected, all feeding into your AI LifeCoach. No more switching tabs, syncing data, or losing information in the gaps between tools. Everything lives together and references everything else.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Get smart reminders and nudges about your goals and tasks. Your AI LifeCoach holds you accountable in a way that actually helps, not in an annoying way. It notices when you are falling behind on a goal, when a deadline is approaching, or when your weekly review is overdue, and it reaches out with a gentle push.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
